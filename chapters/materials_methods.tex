...
\textcolor{red}{TODO: State the growing media treatments: the peat and biochar components, the biochar feedstock and pyrolysis temperature, the substitution rates tested (e.g.\ \% by volume), the pot volume, and the number of replicate pots per treatment.}
